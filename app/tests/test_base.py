...
class UserUnitTest(TestCase):
    ...
    def login_with_valid_credential_admin(self):

        # Get the JWT token cookie
        response = fakeLogin(self.admin.email, "password")
    ...
    def setUp(self):
        ...
        try:
            ...
            print(e)
        self.create_user()
        # create_admin mainly for supportside testing
        time.sleep(0.1)
        self.create_admin()
